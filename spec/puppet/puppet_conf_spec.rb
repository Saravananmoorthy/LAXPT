...
describe "tests for puppet.conf" do
  describe file('/etc/puppet/puppet.conf') do
    ...
    its(:content) { should match /logdir = \/var\/log\/puppetlabs\/puppetserver/ }
    ...
    its(:content) { should match /vardir = \/opt\/puppetlabs\/server\/data\/puppetserver/}
    ...
    its(:content) { should match /rundir=\/var\/run\/puppetlabs\/puppetserver/ }
